...
Authors: David Mutchler, Dave Fisher, Matt Boutell, Amanda Stouder,
         their colleagues and TJ Ballard.  April 2018.
...
def run_test_problem1():
    ...
    print('Expected for Test1:', expected)
    print('Actual for Test1:', actual)

    expected2 = 1030
    actual2 = problem1([Rect(7, 7),Rect(9, 100),Rect(9, 9)])
    print('Expected for Test2:', expected2)
    print('Actual for Test2:', actual2)
...
def problem1(rectangles):
    ...
    for k in range(len(rectangles)):
        x = rectangles[k].w*rectangles[k].h
        total = total + x
    return total
